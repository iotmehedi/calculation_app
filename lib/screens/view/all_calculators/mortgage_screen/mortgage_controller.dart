...
void calculateMonthlyPayment() {
  ...
  final double propertyTaxRate = double.parse(propertyTaxController.value.text);
  final double annualHomeInsurance = double.parse(homeInsuranceController.value.text);
  final double annualPMIRate = double.parse(pmiFeeController.value.text);
  final double annualHOAFee = double.parse(hoaFeeController.value.text);
