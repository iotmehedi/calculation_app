              ...
              return Padding(
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: controller.courseControllersLetter[index],
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              controller:
                              controller.instructorControllersLetter[index],
                              decoration: const InputDecoration(
                                border: InputBorder.none,
                                contentPadding:
                                EdgeInsets.only(right: 10, left: 10),
                    ...
                    10.ph,
                    controller.courseControllersLetter.length - 1 == index ?  InkWell(
                        onTap: (){
